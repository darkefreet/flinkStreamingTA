...
public class CollectTerms {
    public static void main(String[] args) throws Exception{
        ...
        InputStream fis = new FileInputStream("resource/stopwords");
        ...
        File folder = new File("resource/news/");
        ...
        PrintWriter outputFile = new PrintWriter(new FileWriter("resource/terms.txt"));
